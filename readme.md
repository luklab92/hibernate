...
<hibernate-configuration>
    <session-factory>
        ...
        <!--powyższa linia służy do wskazania hibernate'owi sterownika bazy danych-->        <property name="connection.username">root</property>
        <property name="connection.password">root</property>        <!--DB schema will be updated if needed -->
        ...
        <property name="show_sql">true</property>        <!--TODO: na potem - dopisanie klas obsługiwanych przez hibernate -->
