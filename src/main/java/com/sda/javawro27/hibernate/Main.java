...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            // https://pl.spoj.com/
            System.out.println("Podaj komendę [add/list/delete/update/findByName/byAge/bybeh/quit]");
            ...
            } else if (komenda.equalsIgnoreCase("findByName")) {
                findByName(dao,scanner);
            ...
            }else if (komenda.equalsIgnoreCase("habove")) {
                findByHeightAbove(dao, scanner);
            }

        } while (!komenda.equalsIgnoreCase("quit"));
    }

    private static void findByHeightAbove(StudentDao dao, Scanner scanner) {
        System.out.println("Podaj parametry: Height");
        String linia = scanner.nextLine();
        double height = Double.parseDouble(linia);

        System.out.println("Znalezione rekordy: ");
        dao.findByHeightAbove(height).forEach(System.out::println);
    }
    ...
    private static void findByName(StudentDao dao, Scanner scanner) {
        System.out.println("Wyszukiwanie przez imie:");
    ...
    private static void deleteStudent(StudentDao dao, Scanner scanner) {
        ...
        // nie da sie usunac rekordu o id
    }
